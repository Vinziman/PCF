            ...
            <div class="areapc">
                ...
                /*connessione al db*/
                    ...
                    if($ram!=null){
                        $select="SELECT * 
                                from pc
                                where cpu like '$cpu%' and ram='$ram' and rom like '%$rom%' and so like '%$so%' and prezzo between '$minprice' and '$maxprice' and modello like '%$modello%' or marca like '%$marca%' 
                                order by marca asc";
                    }
                    else{
                        $select="SELECT * 
                            from pc
                            where cpu like '$cpu%' and rom like '%$rom%' and so like '%$so%' and prezzo between '$minprice' and '$maxprice' and modello like '%$modello%' or marca like '%$marca%'
                            order by 'marca' asc";
                    }
                                    ...
                                    <img src="<?php echo $row["immagine"] ?>" alt="<?php echo $row["marca"]. " " .$row["modello"]." ".$row["cpu"]." ".$row["ram"]?>GB<?php echo " ".$row["capienza"]?>GB" id="pcimage"/>
                                        ...
                                        <div id="pcdesc">
                                            ...
                                            <form action="schedatecnica.php" method="get">
                                                <input type="submit" value="(<?php echo $row["id"]?>)<?php echo $row["marca"]. " " .$row["modello"]?>" id="scheda">
                                            </form>
                                        </div>                                                                   
                                </div> 
                            <?php
